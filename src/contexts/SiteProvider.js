...
import { setUserSession, getUserSession } from '../Service/sessionService';
...
export const SiteProvider = ({ children }) => {
    ...
    const logout = () => {
        ...
        showAlertAutoClose("Logged Out Successfully","success");
        setUser(null);
      };
    ...
    return (
        <SiteContext.Provider value={{ setLoading, user, setUser, openModal, closeModal,startSessionAct,logout }}>
            {children}
            <PageLoader loading={isLoading} message={loadingMsg} />
